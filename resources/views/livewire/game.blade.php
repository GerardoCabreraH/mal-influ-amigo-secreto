<div class="flex items-center justify-center min-h-screen py-20 bg-gradient-to-t from-red-500 to-green-500">
    <div class="w-10/12 bg-white lg:w-5/12 md:w-6/12 shadow-3xl">
        ...
        <form class="p-12 pt-20">
            @foreach ($players as $key => $player)
                <div wire:key="{{$key}}" class="mb-5">
                    <div class="flex items-center gap-4 text-lg">
                        ...
                        <input type="text" placeholder="Nombre del jugador" class="w-full py-2 pl-12 bg-gray-200 md:py-4 focus:outline-none" wire:model="players.{{$key}}.name">
            ...
            @endforeach
            <button type="button" class="w-full p-2 font-medium text-gray-900 uppercase bg-gradient-to-b from-gray-300 to-gray-400 md:p-4 hover:from-gray-400 hover:to-gray-500" wire:click="addPlayer">
                Añadir Jugador
            </button>
            <button type="button" class="w-full p-2 mt-2 font-medium text-white uppercase bg-gradient-to-b from-gray-700 to-gray-800 md:p-4 hover:from-gray-800 hover:to-gray-900" wire:click="startGame">
                Empezar Juego
            </button>
        </form>
